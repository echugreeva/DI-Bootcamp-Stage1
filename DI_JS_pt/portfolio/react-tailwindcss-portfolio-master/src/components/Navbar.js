  ...
  return (
    <header className="bg-indigo-800 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
        ...
        <a
          href="#contact"
          className="inline-flex  hover:bg-pink-900 items-center py-2 px-6 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0 ring-2 ring-pink-500">
